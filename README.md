...
#### Current Version 1.5.0 (May 12th, 2022; Path of Exile v3.18)
...
Pre-requisites for loading the project up:
...
If you could ping me on Discord that would be awesome, especially if you want to make bigger changes. It'll probably be the quickest way to talk to me about code reviews, new features, design, etc.
