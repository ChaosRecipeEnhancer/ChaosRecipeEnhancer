...
public static class ThemesController
{
    ...
    //private static ResourceDictionary GetControlColours() => Application.Current.Resources.MergedDictionaries[1];

    private static void SetControlColours(ResourceDictionary value)
    {
        Application.Current.Resources.MergedDictionaries[1] = value;
    }
    ...
    public static void SetTheme(ThemeType theme)
    {
        ...
        SetControlColours(new ResourceDictionary() { Source = new Uri("Themes/ControlColours.xaml", UriKind.Relative) });
        RefreshControls();
    }
