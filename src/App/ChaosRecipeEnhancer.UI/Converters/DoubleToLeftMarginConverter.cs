...
/// <summary>
/// Converts a double value to a Thickness value with the double value as the left margin.
/// </summary>
public sealed class DoubleToLeftMarginConverter : IValueConverter
{
    ...
    /// <returns>A Thickness value with the double value as the left margin if the input is a double; otherwise, DependencyProperty.UnsetValue.</returns>
