...
internal sealed class ItemSetManager : ViewModelBase, ISelectedStashTabHandler
{
	...
	public ItemSetManager() => Settings.Default.PropertyChanged += OnSettingsChanged;

	private void OnSettingsChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
	{
		if (e.PropertyName == nameof(Settings.FullSetThreshold) || e.PropertyName == nameof(Settings.SetTrackerOverlayItemCounterDisplayMode))
		{
	...
	{
		_itemSetList.Clear();
		for (int i = 0; i < Settings.Default.FullSetThreshold; i++)
		{
