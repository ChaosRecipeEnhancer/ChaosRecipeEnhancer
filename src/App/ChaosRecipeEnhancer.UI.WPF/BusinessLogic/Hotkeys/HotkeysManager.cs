...
namespace ChaosRecipeEnhancer.UI.WPF.BusinessLogic.Hotkeys;
...
public static class HotkeysManager
{
	...
	// All of the Hotkeys
	private static List<GlobalHotkey> Hotkeys
	{
		get; set;
	}
	...
	/// </summary>
	public static bool IsHookSetup
	{
		get; private set;
	}
	...
	///     </para>
	/// </summary>
	public static bool RequiresModifierKey
	{
		get; set;
	}
